...
const CreateEventForm = ({ onEventCreated }) => {
  ...
  const handleCreateEvent = async (e) => {
    e.preventDefault();
    try {
      // Validăm și convertim datele și orele
      ...
      console.log('Notificare succes declanșată'); // Log 1: Verificăm dacă ajungem aici
      ...
      setError('Eroare la crearea evenimentului: ' + err.message);
      console.error('Eroare la crearea evenimentului:', err);

      // Afișează notificare de eroare
      console.log('Notificare eroare declanșată'); // Log 2: Verificăm dacă ajungem aici
