...
const StaffPage = ({ userId, handleLogout }) => {
  ...
  // Funcție pentru a afișa mesajul de confirmare la logout
          ...
          <div className="header-actions">
            ...
            <button onClick={handleLogoutWithConfirmation} className="logout-btn">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 1v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"
                />
                <path
                  fillRule="evenodd"
              ...
              <div className="profile-header">
                <div className="profile-avatar">
                  {staffInfo.staffId?.image ? (
                    <img src={`http://localhost:5000${staffInfo.staffId.image}`} alt="Profile" className="profile-image" />
                  ) : (
